...
func GetkycHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		url := fmt.Sprintf("%s/kyc", cfg.BaseURL)
...
func CreateGetkycTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_kyc",
