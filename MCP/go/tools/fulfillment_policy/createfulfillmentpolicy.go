...
func CreatefulfillmentpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/fulfillment_policy/", cfg.BaseURL)
...
func CreateCreatefulfillmentpolicyTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatefulfillmentpolicyHandler(cfg),
	}
}
